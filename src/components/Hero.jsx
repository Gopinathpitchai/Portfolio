      ...
      <div className="container hero-container">
        ...
        <div className="hero-content">
          ...
          <div className="status-pill hero-badge">
            ...
            <span className="truncate">Open for Opportunities &bull; Fresher / MCA</span>
          </div>
          ...
          <div className="hero-typewriter-container" aria-label="Current Role">
          ...
          <div className="hero-contact-chips">
            <div 
              ...
              role="button"
              tabIndex={0}
              onKeyDown={(e) => e.key === 'Enter' && copyToClipboard(personal.email, 'Email')}
            >
            ...
            <div 
              ...
              role="button"
              tabIndex={0}
              onKeyDown={(e) => e.key === 'Enter' && copyToClipboard(personal.phone, 'Phone number')}
            >
        ...
        {/* Right Column: Hero Visual - Portrait & Config */}
            ...
            <div className="profile-glass-card">
              <div className="card-top-bar">
                ...
                <div className="card-tab-switch">
                  <span className="card-tag">gopinath.profile</span>
                </div>
              </div>
              ...
              <div className="hero-portrait-showcase">
                ...
                <div className="card-code-preview compact">
                  <div className="code-line whitespace-nowrap">
              ...
              {/* Floating micro-badges - bounded on mobile */}
